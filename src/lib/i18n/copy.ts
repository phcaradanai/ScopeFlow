...
export const copy: Record<Locale, LocaleCopy> = {
  th: {
    ...
    quality: {
      ...
      answerIntakeTitle: 'ข้อมูลที่ลูกค้าตอบกลับ',
      answerIntakeDescription: 'วางคำตอบลูกค้าจาก Follow-up แล้ว ScopeFlow จะช่วยดูว่าควรอัปเดต Brief, Scope, เปิด Change Request, ถามต่อ หรือไม่ต้องทำอะไร',
      answerPlaceholder: 'เช่น ลูกค้าตอบว่า deadline คือสิ้นเดือนนี้, ต้องเพิ่มรายงานยอดขาย, หรือยังไม่แน่ใจเรื่องงบประมาณ',
      analyzeAnswer: 'วิเคราะห์คำตอบนี้',
      answerImpactTitle: 'คำตอบนี้กระทบ Brief/Scope อย่างไร',
      safeUpdate: 'อัปเดตเอกสารอย่างปลอดภัย',
      updateBriefSafely: 'อัปเดต Brief อย่างปลอดภัย',
      updateScopeSafely: 'อัปเดต Scope อย่างปลอดภัย',
      createChangeRequestInstead: 'สร้าง Change Request แทนการแก้ Scope เดิม',
      askMoreQuestions: 'สร้าง Follow-up เพื่อถามต่อ',
      noActionNeeded: 'ยังไม่ต้องทำอะไร',
      changedItems: 'สิ่งที่เปลี่ยนหรือได้คำตอบเพิ่ม',
      suggestedUpdate: 'ข้อเสนอสำหรับอัปเดต',
      followUpQuestions: 'คำถามที่ควรถามต่อ',
      readinessGateTitle: 'Project Readiness Gate',
      readinessGateDescription: 'ตรวจความพร้อมของโครงการตั้งแต่คำขอลูกค้าถึงส่งมอบ เพื่อบอกว่าพร้อมไปต่อหรือยังและยังติดอะไร',
      readyForBrief: 'พร้อมทำ Brief',
      readyForScope: 'พร้อมทำ Scope',
      readyForQuote: 'พร้อมเสนอราคา',
      readyForApproval: 'พร้อมขออนุมัติ',
      readyForDelivery: 'พร้อมส่งมอบ',
      blockedByWork: 'ยังติดบางอย่างก่อนเดินต่อ',
      blockersTitle: 'ยังติดอะไร',
      noBlockers: 'ไม่พบ blocker สำคัญ',
      nextAction: 'action ถัดไป',
      cannotQuote: 'ยังไม่ควรเสนอราคา',
      cannotDeliver: 'ยังไม่ควรส่งมอบ',
      openFollowUp: 'ยังติดคำตอบลูกค้า',
      openChangeRequest: 'มี Change Request ที่ยังไม่ปิด',
      score: {
        ready: 'พร้อมใช้ต่อ',
    ...
    scopeWorkshop: {
      ...
      currentBrief: 'Brief ปัจจุบัน',
      latestScope: 'Scope ปัจจุบัน',
      whatChanged: 'สิ่งที่เปลี่ยน',
      missingInfo: 'สิ่งที่ยังไม่ชัด',
      followUpQuestions: 'คำถามที่ควรถามเพิ่ม',
      updateBrief: 'อัปเดต Brief',
      updateScope: 'อัปเดต Scope',
      createFollowUp: 'สร้าง Follow-up',
      createChangeRequest: 'สร้าง Change Request',
      acceptScope: 'ยอมรับ Scope นี้สำหรับการทำงาน',
      closeScopeLoop: 'ปิดรอบการทำ Scope',
      evolutionHistory: 'ประวัติการเปลี่ยน Brief/Scope',
      iterationNumber: 'รอบที่',
      newCustomerMessage: 'ข้อความใหม่จากลูกค้า',
      changesFromPrevious: 'สิ่งที่เปลี่ยนจากครั้งก่อน',
      addedItems: 'สิ่งที่เพิ่ม',
      changedItems: 'สิ่งที่เปลี่ยน',
      removedItems: 'สิ่งที่ตัดออก',
      recommendedNextAction: 'คำแนะนำถัดไป',
      recheckQuote: 'ตรวจ Quote ใหม่',
      noScopeImpact: 'ไม่มีผลต่อ Scope',
      status: {
  ...
  en: {
    ...
    quality: {
      ...
      answerIntakeTitle: 'Customer answer returned',
      answerIntakeDescription: 'Paste the customer answer from a Follow-up and ScopeFlow will decide whether to update Brief, update Scope, create a Change Request, ask more, or do nothing.',
      answerPlaceholder: 'Example: the deadline is end of month, add a sales report, or budget is still unclear.',
      analyzeAnswer: 'Analyze this answer',
      answerImpactTitle: 'How this answer affects Brief/Scope',
      safeUpdate: 'Safe document update',
      updateBriefSafely: 'Update Brief safely',
      updateScopeSafely: 'Update Scope safely',
      createChangeRequestInstead: 'Create Change Request instead of editing Scope',
      askMoreQuestions: 'Create Follow-up to ask more',
      noActionNeeded: 'No action needed',
      changedItems: 'Changed or clarified items',
      suggestedUpdate: 'Suggested update',
      followUpQuestions: 'Questions to ask next',
      readinessGateTitle: 'Project Readiness Gate',
      readinessGateDescription: 'Checks project readiness from request to delivery and shows what is blocking the next step.',
      readyForBrief: 'Ready for Brief',
      readyForScope: 'Ready for Scope',
      readyForQuote: 'Ready for Quote',
      readyForApproval: 'Ready for Approval',
      readyForDelivery: 'Ready for Delivery / Acceptance',
      blockedByWork: 'Blocked before continuing',
      blockersTitle: 'What is blocking progress',
      noBlockers: 'No major blockers found',
      nextAction: 'Next action',
      cannotQuote: 'Not ready to quote',
      cannotDeliver: 'Not ready to deliver',
      openFollowUp: 'Waiting for customer answer',
      openChangeRequest: 'Open Change Request exists',
      score: {
        ready: 'Ready',
    ...
    scopeWorkshop: {
      ...
      evolutionHistory: 'Brief/Scope Evolution History',
      iterationNumber: 'Iteration',
      newCustomerMessage: 'New Customer Message',
      changesFromPrevious: 'Changes from previous',
      addedItems: 'Added',
      changedItems: 'Changed',
      removedItems: 'Removed',
      recommendedNextAction: 'Recommended Next Action',
      recheckQuote: 'Re-check Quote',
      noScopeImpact: 'No Impact on Scope',
      status: {
        collectingBrief: 'Collecting brief',
        scopeDraftReady: 'Scope draft ready',
        waitingForCustomer: 'Waiting for customer answer',
