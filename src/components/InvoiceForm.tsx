...
import { InvoiceFormData, LineItem, calculateInvoiceTotals } from '../lib/invoice-builder';
...
export default function InvoiceForm({ workspacePath, initialData, onGenerate }: InvoiceFormProps) {
  const [formData, setFormData] = useState<InvoiceFormData>(initialData || defaultData);
  ...
  function handleChange(field: keyof InvoiceFormData, value: any) {
