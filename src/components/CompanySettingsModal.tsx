      ...
      <div className="modal-container modal-container-sm">
        ...
        <form onSubmit={handleSave} className="modal-body">
          ...
          <div className="form-section border-t border-border pt-6 mt-6">
            <h3 className="form-section-title">AI Provider (การตั้งค่า AI)</h3>
            <p className="form-section-helper">จัดการผู้ให้บริการ AI (เช่น Ollama หรือ OpenAI-compatible API)</p>
            <AiProviderManager workspacePath={workspacePath} />
          </div>
        </form>
